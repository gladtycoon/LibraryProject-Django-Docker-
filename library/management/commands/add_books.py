...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for book_data in books:
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f'Успешное добавление книги: {book.title}'))
            else:
                self.stdout.write(self.style.WARNING(f'Книга была добавлена ранее: {book.title}'))
